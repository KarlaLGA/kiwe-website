...
// new CircleType(document.getElementById('member-1-name'))
//   .radius(300);

//   new CircleType(document.getElementById('member-2-name'))
//   .radius(300);

//   new CircleType(document.getElementById('member-3-name'))
//   .radius(300);

//   new CircleType(document.getElementById('member-4-name'))
//   .radius(300);

//   new CircleType(document.getElementById('member-5-name'))
//   .radius(300);

//   new CircleType(document.getElementById('member-6-name'))
//   .radius(300);

  let allMember = document.querySelectorAll('.team-member-name');

  for (let i=0; i <allMember.length; i++) {
    new CircleType(allMember[i])
    // .forceWidth(true)
    .radius(200);
    
  }

  let allMemberPos = document.querySelectorAll('.team-member-role');

  for (let j=0; j <allMemberPos.length; j++) {
    new CircleType(allMemberPos[j])
    .dir(-1)
    .radius(200);
