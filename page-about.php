								...
								<div class="single-team-member">
									<div class="team-member">
										<?php
											$i++;
											?>
												<h2 class="team-member-name" id="member-<?php echo $i ?>-name"><?php the_title() ?></h2>
										<?php
